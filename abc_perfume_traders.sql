...
-- 7 Main trigger This trigger will update the Inventory table
--  whenever a new order item is inserted, reducing the stock quantity based on the ordered quantity:
DELIMITER //
...
-- Creating Views:
-- This view will display detailed order information including customer name, product names, quantities, and total prices
